        ...
        def trackback(cur_need, money):
            ...
            for sp in special:
                ...
                for i, num in enumerate(sp[:-1]):
                    ...
                    trackback(cur, money + sp[-1])

        trackback(needs, 0)
        return int(res[0])

    def shoppingOffers2(self, price, special, needs) -> int:
...
if __name__ == '__main__':
    sol = Solution()
    print(sol.shoppingOffers2(price=[2, 5], special=[[3, 0, 5], [1, 2, 10]], needs=[3, 2]))
